...
library DotsMetadata {
    ...
    function _attributes(IDots.Dot memory c) private pure returns (string memory) {
        // Split into two concat calls to stay under stack-depth limits on string.concat.
        string memory part1 = string.concat(
            '[{"trait_type":"Glyphs","value":',
        ...
        string memory part3 = string.concat(
            ...
            c.direction == 0 ? "Forward" : "Reverse",
            '"},{"trait_type":"Speed","value":',
            Strings.toString(uint256(c.speed)),
